  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user) {
        ...
        console.log("Profile setup successful. Showing popup...");
        setPopupMessage("Profile setup successful");
      ...
      setPopupMessage("There was an error setting up the profile. Please try again.");
      setShowPopup(true); // Show the popup
    }
  };
